  ...
  return (
    <div
      className={cn(
        ...
        hoverable && 'hover:-translate-y-1 hover:shadow-[0_12px_36px_-4px_rgba(74,53,37,0.08),0_4px_12px_-2px_rgba(74,53,37,0.04)] hover:border-outline-variant/60 cursor-pointer',
        className
      )}
      {...props}
    />
