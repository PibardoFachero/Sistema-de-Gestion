...
import { extractScheduleFromImageWithGemini } from '@/services/ai/scheduleAiService';
import { z } from 'zod';
 ...
 * opcionalmente guarda los bloques en 'bloques_disponibilidad' y retorna
 * los bloques estructurados listos para el calendario.
 */
